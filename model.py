...
# 1.verileri etiketle
# 2.verileri eğitim, test setlerine böl
# 3.modeli oluştur eğit, derle, değerlendir
# (bak apo modelin doğruluğu çok iyi sonuç verdi bunun sebebei tabikide "veri çoğaltma" adımıdır)
# (senin o negatif test verilerinde yanlış sonuç vermesinin sebebi sadece bir türde(turuncu kelebek) seçmendir.
# (türleri çoğaltırsan modelin doğuruluk oranı artar))
...
# verileri etiketle
def verileri_etiketleme(positive_dir, negative_dir):
    images, labels = [], []
...
x, y = verileri_etiketleme(positive_folder, negative_folder)

# train ve test setlerine bölme
